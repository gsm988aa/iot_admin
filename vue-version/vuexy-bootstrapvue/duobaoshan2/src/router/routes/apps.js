export default [
  ...
  //   component: () => import('@/views/apps/closingopening/closingopening.vue'),
  // },
  // {
  //   path: '/apps/breaker',
  //   name: 'apps-breaker',
  ...
  // },
  // {
  //   path: '/apps/mcpiot/mcp',
  //   name: 'apps-mcpiot-mcp',
  //   component: () => import('@/views/apps/mcpiot/mcp/mcp.vue'),
  // },
  // {
  //   path: '/apps/mcpiot/iot',
  //   name: 'apps-mcpiot-iot',
  //   component: () => import('@/views/apps/mcpiot/iot/iot.vue'),
  // },
  // {
  //   path: '/apps/settings/usersettings',
  //   name: 'apps-settings-usersettings',
  //   component: () => import('@/views/apps/settings/usersettings/usersettings.vue'),
  // },
  // {
  //   path: '/apps/settings/othersettings',
  //   name: 'apps-settings-othersettings',
  //   component: () => import('@/views/apps/settings/othersettings/othersettings.vue'),
  // },
