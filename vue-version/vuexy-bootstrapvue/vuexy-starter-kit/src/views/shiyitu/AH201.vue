...
export default {
  ...
  data() {
    return {
      ...
      options: [
        ...
        { value: '192.168.6.104', text: 'AH206 192.168.6.106' },
        { value: '192.168.6.105', text: 'AH209 192.168.6.109' },
        { value: '192.168.6.106', text: 'AH210 192.168.6.110' },
        { value: '192.168.6.107', text: 'AH211 192.168.6.111' },
      ],
  ...
  methods: {
    ...
    stop201gaojing() {
      ...
      // 停止数据更新逻辑
      axios.post(`http://${this.ip}/spyaoxin`).then(response => {
