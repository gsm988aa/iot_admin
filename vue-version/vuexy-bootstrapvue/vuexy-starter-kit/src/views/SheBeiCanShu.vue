...
<script>
import {
  BTable, BCard, BButton, BCollapse, BCardText, BRow, BCol, BSpinner,
} from 'bootstrap-vue'
  ...
  methods: {
    ...
    togglecheru06(append = false) {
      ...
      if (!this.isDisabled) {
        ...
        setTimeout(() => {
          ...
          this.text = '指令发送成功！'
          // eslint-disable-next-line no-unused-vars
          axios.post('http://192.168.6.104/cheru')
              .then(response => {
              })
        }, 1000)
        this.text = '执行手车驶入'
    ...
    togglecheru09(append = false) {
      ...
      if (!this.isDisabled) {
        ...
        setTimeout(() => {
          ...
          this.text = '指令发送成功！'
          // eslint-disable-next-line no-unused-vars
          axios.post('http://192.168.6.105/cheru')
              .then(response => {
              })
        }, 1000)
        this.text = '执行手车驶入'
    ...
    togglecheru11(append = false) {
      ...
      if (!this.isDisabled) {
        ...
        setTimeout(() => {
          ...
          this.text = '指令发送成功！'
          // eslint-disable-next-line no-unused-vars
          axios.post('http://192.168.6.107/cheru')
              .then(response => {
              })
        }, 1000)
        this.text = '执行手车驶入'
    ...
    togglechechu06(append = false) {
      ...
      setTimeout(() => {
        ...
        this.text = '指令发送成功！'
        // eslint-disable-next-line no-unused-vars
        axios.post('http://192.168.6.104/chechu')
            .then(response => {
            })
      }, 1000)
      this.text = '执行手车驶出'
    ...
    togglechechu09(append = false) {
      ...
      setTimeout(() => {
        ...
        this.text = '指令发送成功！'
        // eslint-disable-next-line no-unused-vars
        axios.post('http://192.168.6.105/chechu')
            .then(response => {
            })
      }, 1000)
      this.text = '执行手车驶出'
    ...
    togglechechu11(append = false) {
      ...
      setTimeout(() => {
        ...
        this.text = '指令发送成功！'
        // eslint-disable-next-line no-unused-vars
        axios.post('http://192.168.6.107/chechu')
            .then(response => {
            })
      }, 1000)
      this.text = '执行手车驶出'
    ...
    toggledaohe09(append = false) {
      ...
      if (!this.isDisabled) {
        ...
        setTimeout(() => {
          ...
          this.isDisabled = false
          this.text = '指令发送成功！'
          axios.post('http://192.168.6.105/daohe').then(response => {
          })
        }, 1000)
        this.text = '执行闭合接地刀操作'
      }
    ...
    toggledaohe10(append = false) {
      ...
      if (!this.isDisabled) {
        ...
        setTimeout(() => {
          ...
          this.isDisabled = false
          this.text = '指令发送成功！'
          axios.post('http://192.168.6.106/daohe').then(response => {
          })
        }, 1000)
        this.text = '执行闭合接地刀操作'
      }
    ...
    toggledaohe11(append = false) {
      ...
      if (!this.isDisabled) {
        ...
        setTimeout(() => {
          ...
          this.isDisabled = false
          this.text = '指令发送成功！'
          axios.post('http://192.168.6.107/daohe').then(response => {
          })
        }, 1000)
        this.text = '执行闭合接地刀操作'
      }
    ...
    toggledaofen09(append = false) {
      ...
      if (!this.isDisabled) {
        ...
        setTimeout(() => {
          ...
          this.isDisabled = false
          this.text = '指令发送成功！'
          axios.post('http://192.168.6.105/daofen').then(response => {
          })
        }, 1000)
        this.text = '执行断开接地刀操作'
      }
    ...
    toggledaofen10(append = false) {
      ...
      if (!this.isDisabled) {
        ...
        setTimeout(() => {
          ...
          this.isDisabled = false
          this.text = '指令发送成功！'
          axios.post('http://192.168.6.106/daofen').then(response => {
          })
        }, 1000)
        this.text = '执行断开接地刀操作'
      }
    ...
    toggledaofen11(append = false) {
      ...
      if (!this.isDisabled) {
        ...
        setTimeout(() => {
          ...
          this.isDisabled = false
          this.text = '指令发送成功！'
          axios.post('http://192.168.6.107/jiedife').then(response => {
          })
        }, 1000)
        this.text = '执行断开接地刀操作'
      }
    ...
    toggleyigong06(append = false) {
      ...
      if (!this.isDisabled) {
        ...
        setTimeout(() => {
          ...
          this.isDisabled = false
          this.text = '指令发送成功！'
          axios.post('http://192.168.6.104/yigong').then(response => {
          })
        }, 1000)
        this.text = '执行一键送电'
      }
    ...
    toggleyigong09(append = false) {
      ...
      if (!this.isDisabled) {
        ...
        setTimeout(() => {
          ...
          this.isDisabled = false
          this.text = '指令发送成功！'
          axios.post('http://192.168.6.105/yigong').then(response => {
          })
        }, 1000)
        this.text = '执行一键送电'
      }
    ...
    toggleyigong11(append = false) {
      ...
      if (!this.isDisabled) {
        ...
        setTimeout(() => {
          ...
          this.isDisabled = false
          this.text = '指令发送成功！'
          axios.post('http://192.168.6.107/yigong').then(response => {
          })
        }, 1000)
        this.text = '执行一键送电'
      }
    ...
    toggleyiduan06(append = false) {
      ...
      if (!this.isDisabled) {
        ...
        setTimeout(() => {
          ...
          this.isDisabled = false
          this.text = '指令发送成功！'
          axios.post('http://192.168.6.104/yiduan').then(response => {
          })
        }, 1000)
        this.text = '执行一键断电'
      }
    ...
    toggleyiduan09(append = false) {
      ...
      if (!this.isDisabled) {
        ...
        setTimeout(() => {
          ...
          this.isDisabled = false
          this.text = '指令发送成功！'
          axios.post('http://192.168.6.105/yiduan').then(response => {
          })
        }, 1000)
        this.text = '执行一键断电'
      }
    ...
    toggleyiduan11(append = false) {
      ...
      if (!this.isDisabled) {
        ...
        setTimeout(() => {
          ...
          this.isDisabled = false
          this.text = '指令发送成功！'
          axios.post('http://192.168.6.107/yiduan').then(response => {
          })
        }, 1000)
        this.text = '执行一键断电'
      }
    ...
    togglefuwei06(append = false) {
      ...
      if (!this.isDisabled) {
        ...
        setTimeout(() => {
          ...
          this.isDisabled = false
          this.text = '指令发送成功！'
          axios.post('http://192.168.6.104/reboot').then(response => {
          })
        }, 1000)
        this.text = '执行复位'
      }
    ...
    togglefuwei09(append = false) {
      ...
      if (!this.isDisabled) {
        ...
        setTimeout(() => {
          ...
          this.isDisabled = false
          this.text = '指令发送成功！'
          axios.post('http://192.168.6.105/reboot').then(response => {
          })
        }, 1000)
        this.text = '执行复位'
      }
    ...
    togglefuwei11(append = false) {
      ...
      if (!this.isDisabled) {
        ...
        setTimeout(() => {
          ...
          this.isDisabled = false
          this.text = '指令发送成功！'
          axios.post('http://192.168.6.107/reboot').then(response => {
          })
        }, 1000)
        this.text = '执行复位'
      }
