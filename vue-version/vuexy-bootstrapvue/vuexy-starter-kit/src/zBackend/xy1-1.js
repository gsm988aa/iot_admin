...
app.use(
  cors({
    origin: ["http://localhost:10866", "http://localhost:11866",  "http://localhost:8080", "http://127.0.0.1:8080", "http://192.168.2.42:8080", "http://192.168.3.103:8080",'http://localhost:8888','http://localhost:9999', 'http://10.168.1.220:8888', 'http://localhost:8080', 'http://192.168.6.185:7777','http://192.168.6.185', 'http://192.168.6.185', "http://192.168.6.191"]
  })
);
app9999.use(
  cors({
