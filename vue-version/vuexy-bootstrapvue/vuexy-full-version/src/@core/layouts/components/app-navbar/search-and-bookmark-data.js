...
export default {
  pages: {
    ...
    data: [
	  ...
	  { title: 'Dashboard Userinfos', route: { name: 'dashboard-userinfos' }, icon: 'ActivityIcon', isBookmarked: false },
	  { title: 'Dashboard Deviceinfos', route: { name: 'dashboard-deviceinfos' }, icon: 'ActivityIcon', isBookmarked: false },
